...
namespace DeathwatchMod
{
    ...
    internal static class ChargenContent
    {
        ...
        // per-unit patch (EquipmentRestrictionHasFacts_CanBeEquippedBy_MarineWeapons_Patch in MarineEquipment).
        ...
        // release gate. It is now the per-unit EquipmentRestrictionHasFacts_CanBeEquippedBy_MarineWeapons_Patch in
        // Gameplay\MarineEquipment.cs -- since generalized to all non-saw 2H melee + plasma/flame ranged -- scoped
        // to this mod's marine; the vanilla exclusion stays intact.)
    }
